...
import { Component, Inject, OnInit, OnDestroy, OnChanges, SimpleChanges, PLATFORM_ID } from '@angular/core';
...
export class SettingsImportComponent implements OnInit {
    ...
    constructor(public _shared: SharedService, public _walletService: WalletService, private _router: Router,
        @Inject('BASE_URL') public baseUrl: string, private route: ActivatedRoute, private _device: DeviceDetectorService,
    ...
    ngOnInit(): void {
        this.timer = setInterval(() => {
            ...
            if (Util.isValidAndNotEmpty(fieldValue) && this.import.privateKey !== fieldValue) {
